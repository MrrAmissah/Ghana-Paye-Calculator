        ...
        <div className="flex flex-col gap-6 p-6">
          ...
          <div className="flex flex-col items-center gap-3 border-t border-edge pt-5 text-center">
            <p className="text-xs text-fore-3">
              Data source: <span className="text-fore-2 font-medium">Ghana Revenue Authority (GRA)</span> · 2026 tax year
            </p>
            <div className="flex items-center gap-2">
              <span className="text-xs text-fore-3">Built by</span>
              <span className="text-sm font-bold text-copper">MrrAmissah</span>
              <a
                href="https://www.linkedin.com/in/prince-kofi-frimpong-amissah/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-7 w-7 items-center justify-center rounded-full border border-edge text-fore-3 transition-colors hover:border-copper/40 hover:text-copper"
                title="LinkedIn"
              >
